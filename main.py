...
class Video(QMainWindow):
    ...
    def createToolBarV(self):
        ...
        self.openVideo = self._createToolBar('icons/video-icon.png', self.Video, "Ctrl+O")
        self.openCamera = self._createToolBar('icons/512px-Video_camera_icon.svg.png', self.Camera, "Ctrl+S")      
    ...
    def Video(self):       
        ...
        self, "Open file", ".", "Image Files (*.mp4)"
        )
        if not file_name:
            return
    ...
    def Camera(self):
        # self.scene.clear()
        self.threadCamera.cap = cv2.VideoCapture('lunge_2.mp4')
